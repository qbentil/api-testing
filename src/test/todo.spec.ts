...
describe('Todo Router', () => {
    ...
    describe('POST /create', () => {
        ...
        it('should return 500 if createTodo service fails', async () => {
            (Services.createTodo as jest.Mock).mockRejectedValueOnce(new Error('Database error'));
    ...
    describe('GET /', () => {
        ...
        it('should return 500 if getTodos fails', async () => {
            (Services.getTodos as jest.Mock).mockRejectedValueOnce(new Error('Database error'));
    ...
    describe('PUT /update/:id', () => {
        it('should update a todo with valid id and body', async () => {
            ...
            const requestBody = { title: 'Updated Todo', description: 'Updated Description' };
        ...
        it('should return 400 for invalid ID format', async () => {
            (Services.updateTodo as jest.Mock).mockRejectedValueOnce(new Error('Invalid ID format'));
    ...
    describe('DELETE /delete/:id', () => {
        ...
        it('should return error if id is not provided', async () => {
            (Services.deleteTodo as jest.Mock).mockRejectedValueOnce(new ApiError('Todo not found', 404));
